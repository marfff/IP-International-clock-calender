...
const App = (props) => {
  ...
  //   console.log('DATE:', timeInformation);
  ...
  useEffect(() => {
    const daylightGreetings = ['GOOD DAY', 'GOOD MORNING', 'GOOD AFTERNOON'];
  ...
  let getWeather = () => {
    fetch(
      ...
      .then((data4) => {
        setweatherdesc(`${data4.hourly[4].weather[0].description} LATER`);
  ...
  return (
    <div className='App' style={{ backgroundImage: `url(${imageUrl})` }}>
      <div className='App-content'>
          ...
          <div className={moreButton}>
            <div className='greeting'>
              ...
              <img
                ...
                alt='sun'
              />
              <span className='greet'>{timeInformation.greeting}</span>
        ...
        <div className='date'> {timeInformation.date} </div>
      </div>
    </div>
  );
};
