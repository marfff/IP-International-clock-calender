	...
	return (
		...
		>
			...
			<div className="extraright">
				...
				<p className="headings">{props.timeInformation.dayOfYear}</p>
				<p className="headings">{props.timeInformation.day}</p>
				<p className="headings">{props.timeInformation.weekNumber}</p>
				{/* {console.log("HENRY",props.extra.latitude)} */}
				<p className="headings">{props.extra.latitude.latitude}</p>
				<p className="headings">{props.extra.longitude.longitude}</p>
				<p className="headings">{props.extra.ipis.ipis}</p>
				<p className="headings">{props.extra.telcode.telcode}</p>{" "}
			</div>
		</div>
	);
};
